...
|---|---|---|---|---|
| `topicAlias` | `string` | ✅ | none | Alias of a declared output topic |
| `file` | `string` | ✅ | none | Expected file path, relative to assets directory |
| `expectedRecordKey` | `string` | ❌ | none | Filter: only accept records with this exact key |
